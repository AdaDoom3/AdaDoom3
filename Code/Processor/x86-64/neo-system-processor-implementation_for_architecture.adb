  ...
  ----------------
    function Get_Vendor
      ...
      type Array_String_Segment
        is array(1..4)
        of Character;
      B, D, C : Array_String_Segment := (others => NULL_CHARACTER_1);
      begin
        Asm(
          Volatile => True,
...
Disable_Put_Stack : Exception;
      begin
-- Comment in/out the below line to enable/disable
Put_Line("Put_Stack is disabled due to an assembly block bug."); raise Disable_Put_Stack;
        Asm(
          Volatile => True,
          Inputs =>(
