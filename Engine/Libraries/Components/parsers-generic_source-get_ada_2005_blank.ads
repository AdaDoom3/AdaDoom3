...
--
--  Get_Ada_2005_Blank -- Skip blanks in the source
--
...
--  feed, form feed, space and also ones of separator space category). A
--  comment  ends  either  at  the  line end or in the one of the format
--  effectors as ARM 2.2 requires. It skips to the next source line when
--  necessary.
--
generic
