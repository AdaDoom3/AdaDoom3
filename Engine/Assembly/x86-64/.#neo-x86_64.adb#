separate(Neo.System.Processor) package body Import is
    ...
    function Get_Clock_Ticks return Integer_8_Unsigned is -- This function will fail O3 optimization in SOME gnat compilers!
...
exception when Disable_Put_Stack => null;
  ...
  begin
    declare Data : aliased Integer_4_Unsigned := 0; begin
      if WORD_SIZE < 32 then raise CPUID_Is_Not_Supported;
