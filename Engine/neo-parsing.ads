...
package Neo.Parsing is
  ...
  --
  --         -- Lets pretend that PNG is a simple text based format (it isn't really)
  ...
  function Split (Item : Str_16; On : Str_16 := " ") return Array_Str_Unbound;
  ...
  package Parser is
      ...
      function Peek return Str_Unbound;
      function Peek return Str     is (To_Str             (Peek));
