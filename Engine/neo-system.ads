...
package Neo.System is
  ...
  function Is_Okay           (Name, Message : in String_2; Buttons : in Enumerated_Buttons := Okay_Button; Icon : in Enumerated_Icon := No_Icon) return Boolean
...
private
  package Import is
      ...
      function Is_Okay(Name, Message : in String_2; Buttons : in Enumerated_Buttons; Icon : in Enumerated_Icon) return Boolean
        with pre => Name'length > 0 and Message'length > 0;
     end Import;
