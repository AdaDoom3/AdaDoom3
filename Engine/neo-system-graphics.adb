  ...
  procedure Initialize(Monitor : in Integer_4_Positive) is
    begin
      ...
      if Monitor = 1 then
        ...
        Put_Line(Localize("Maximum texture units:") & Integer_4_Natural'wide_image(Current_Specifics.Maximum_Texture_Units));
        ...
        if Current_Specifics.Has_Swap_Control_Tear         then Put_Line(Localize("Has swap control tear"));         end if;
        New_Line;
      end if;
    end Initialize;
  procedure Draw is
