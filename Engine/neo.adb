package body Neo is
    ...
    package body Tasks is
        ...
        protected body Protected_Task is
            procedure Initialize               is begin Current_Task := new Task_Unsafe; Data.Set_Number_Of_Tasks(Data.Get_Number_Of_Tasks + 1);              end Initialize;
            procedure Finalize                 is begin Finalize(Current_Task); Current_Task := null; Data.Set_Number_Of_Tasks(Data.Get_Number_Of_Tasks - 1); end Finalize;
