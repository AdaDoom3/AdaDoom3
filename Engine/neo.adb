package body Neo is
  ...
  function To_String_2                      (Item : in Access_Constant_Character_1_C) return String_2                      is begin return To_String_2(To_String_1(Item));                                       end To_String_2;
  ...
  function To_String_2(Item : in Access_Constant_Character_2_C) return String_2 is
    ...
    begin
      while Pointer.all /= NULL_CHARACTER_2_C loop
        ...
        Pointer := To_Unchecked_Access_Constant_Character_2_C(To_Unchecked_Address(To_Unchecked_Integer_Address(Pointer) + Character_2_C'size / Byte'size));
      end loop;
      return To_String_2(Buffer);
  ...
  function To_String_1(Item : in Access_Constant_Character_1_C) return String_1 is 
    ...
    begin
      while Pointer.all /= NULL_CHARACTER_1_C loop
        ...
        Pointer := To_Unchecked_Access_Constant_Character_1_C(To_Unchecked_Address(To_Unchecked_Integer_Address(Pointer) + Character_1_C'size / Byte'size));
      end loop;
