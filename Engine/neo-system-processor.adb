...
package body Neo.System.Processor
  ...
  -------------------
    function Get_Specifics
      ...
      begin
        ...
        Specifics.Speed_In_Megahertz :=
          (Get_Clock_Ticks - Specifics.Speed_In_Megahertz) *
          Integer_8_Unsigned(1.0 / SECONDS_FOR_PROCESSOR_SPEED_TIMING);
        return Specifics;
      end Get_Specifics;
  ---------------------
  -- Get_Clock_Ticks --
  ---------------------
    function Get_Clock_Ticks
      ...
      renames Import.Get_Clock_Ticks;
  ------------------
  -- Set_Rounding --
  ------------------
    procedure Set_Rounding(
      Rounding : in Enumerated_Rounding)
      renames Import.Set_Rounding;
  -------------------
  -- Set_Precision --
  -------------------
    procedure Set_Precision(
      Precision : in Enumerated_Precision)
      renames Import.Set_Precision;
  ---------------
  -- Put_Stack --
  ---------------
    procedure Put_Stack
      renames Import.Put_Stack;
  ----------------------
  -- Check_Exceptions --
  ----------------------
    procedure Check_Exceptions
      renames Import.Check_Exceptions;
  -----------------
  -- Clear_Stack --
  -----------------
    procedure Clear_Stack
      renames Import.Clear_Stack;
  --------------------
  -- Is_Stack_Empty --
  --------------------
    function Is_Stack_Empty
      return Boolean
      renames Import.Is_Stack_Empty;
