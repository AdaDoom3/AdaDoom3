package Neo.OpenGL is
  GL_VERSION_1_1                                : constant Integer_4_Unsigned_C := 1;
  GL_VERSION_1_2                                : constant Integer_4_Unsigned_C := 1;
  GL_VERSION_1_3                                : constant Integer_4_Unsigned_C := 1;
  GL_ARB_IMAGING                                : constant Integer_4_Unsigned_C := 1;
   --  Boolean values
  GL_FALSE                                      : constant Integer_4_Unsigned_C := 16#0000#;
  GL_TRUE                                       : constant Integer_4_Unsigned_C := 16#0001#;
   --  Data types
  GL_BYTE                                       : constant Integer_4_Unsigned_C := 16#1400#;
  ...
  GL_4_BYTES                                    : constant Integer_4_Unsigned_C := 16#1409#;
   --  Primitives
  GL_POINTS                                     : constant Integer_4_Unsigned_C := 16#0000#;
  ...
  GL_POLYGON                                    : constant Integer_4_Unsigned_C := 16#0009#;
   --  Vertex Arrays
  GL_VERTEX_ARRAY                               : constant Integer_4_Unsigned_C := 16#0000_8074#;
  ...
  GL_T4F_C4F_N3F_V4F                            : constant Integer_4_Unsigned_C := 16#2A2D#;
   --  Matrix Mode
  GL_MATRIX_MODE                                : constant Integer_4_Unsigned_C := 16#0BA0#;
  ...
  GL_TEXTURE                                    : constant Integer_4_Unsigned_C := 16#1702#;
   --  Points
  GL_POINT_SMOOTH                               : constant Integer_4_Unsigned_C := 16#0B10#;
  ...
  GL_POINT_SIZE_RANGE                           : constant Integer_4_Unsigned_C := 16#0B12#;
   --  Lines
  GL_LINE_SMOOTH                                : constant Integer_4_Unsigned_C := 16#0B20#;
  ...
  GL_LINE_WIDTH_RANGE                           : constant Integer_4_Unsigned_C := 16#0B22#;
   --  Polygons
  GL_POINT                                      : constant Integer_4_Unsigned_C := 16#1B00#;
  ...
  GL_POLYGON_OFFSET_FILL                        : constant Integer_4_Unsigned_C := 16#0000_8037#;
   --  Display lists
  GL_COMPILE                                    : constant Integer_4_Unsigned_C := 16#1300#;
  ...
  GL_LIST_MODE                                  : constant Integer_4_Unsigned_C := 16#0B30#;
   --  Depth buffer
  GL_NEVER                                      : constant Integer_4_Unsigned_C := 16#0200#;
  ...
  GL_DEPTH_COMPONENT                            : constant Integer_4_Unsigned_C := 16#1902#;
   --  Lighting
  GL_LIGHTING                                   : constant Integer_4_Unsigned_C := 16#0B50#;
  ...
  GL_CLIP_PLANE0                                : constant Integer_4_Unsigned_C := 16#3000#;
  ...
  GL_CLIP_PLANE5                                : constant Integer_4_Unsigned_C := 16#3005#;
   ...
   --  Accumulation buffer
  GL_ACCUM_RED_BITS                             : constant Integer_4_Unsigned_C := 16#0D58#;
  ...
  GL_FEEDBACK_BUFFER_TYPE                       : constant Integer_4_Unsigned_C := 16#0DF2#;
   ...
   --  Selection
  GL_SELECTION_BUFFER_POINTER                   : constant Integer_4_Unsigned_C := 16#0DF3#;
  GL_SELECTION_BUFFER_SIZE                      : constant Integer_4_Unsigned_C := 16#0DF4#;

   --  Fog
  GL_FOG                                        : constant Integer_4_Unsigned_C := 16#0B60#;
  ...
  GL_EXP2                                       : constant Integer_4_Unsigned_C := 16#0801#;
   ...
   --  Logic ops
  GL_LOGIC_OP                                   : constant Integer_4_Unsigned_C := 16#0BF1#;
  ...
  GL_OR_INVERTED                                : constant Integer_4_Unsigned_C := 16#150D#;
   ...
   --  Stencil
  GL_STENCIL_TEST                               : constant Integer_4_Unsigned_C := 16#0B90#;
  ...
  GL_NONE                                       : constant Integer_4_Unsigned_C := 16#0000#;
  ...
  GL_MAX_LIST_NESTING                           : constant Integer_4_Unsigned_C := 16#0B31#;
  ...
  GL_MAX_CLIENT_ATTRIB_STACK_DEPTH              : constant Integer_4_Unsigned_C := 16#0D3B#;
   ...
   --  Gets
  GL_ATTRIB_STACK_DEPTH                         : constant Integer_4_Unsigned_C := 16#0BB0#;
  ...
  GL_VIEWPORT                                   : constant Integer_4_Unsigned_C := 16#0BA2#;
   ...
   --  Evaluators
  GL_AUTO_NORMAL                                : constant Integer_4_Unsigned_C := 16#0D80#;
  ...
  GL_ORDER                                      : constant Integer_4_Unsigned_C := 16#0A01#;
   ...
   --  Hints
  GL_FOG_HINT                                   : constant Integer_4_Unsigned_C := 16#0C54#;
  ...
  GL_NICEST                                     : constant Integer_4_Unsigned_C := 16#1102#;
   ...
   --  Scissor box
  GL_SCISSOR_TEST                               : constant Integer_4_Unsigned_C := 16#0C11#;
  GL_SCISSOR_BOX                                : constant Integer_4_Unsigned_C := 16#0C10#;

   --  Pixel Mode / Transfer
  GL_MAP_COLOR                                  : constant Integer_4_Unsigned_C := 16#0D10#;
  ...
  GL_ZOOM_Y                                     : constant Integer_4_Unsigned_C := 16#0D17#;
   ...
   --  Texture mapping
  GL_TEXTURE_ENV                                : constant Integer_4_Unsigned_C := 16#2300#;
  ...
  GL_TEXTURE_GEN_Q                              : constant Integer_4_Unsigned_C := 16#0C63#;
   ...
   --  Utility
  GL_VENDOR                                     : constant Integer_4_Unsigned_C := 16#1F00#;
  ...
  GL_EXTENSIONS                                 : constant Integer_4_Unsigned_C := 16#1F03#;
   ...
   --  Errors
  GL_NO_ERROR                                   : constant Integer_4_Unsigned_C := 16#0000#;
  ...
  GL_CURRENT_BIT                                : constant Integer_4_Unsigned_C := 16#0001#;
  ...
  GL_ALL_ATTRIB_BITS                            : constant Integer_4_Unsigned_C := 16#000F_FFFF#;
   ...
   --  OpenGL 1.1
  GL_PROXY_TEXTURE_1D                           : constant Integer_4_Unsigned_C := 16#0000_8063#;
  ...
  GL_CLIENT_ALL_ATTRIB_BITS                     : constant Integer_4_Unsigned_C := 16#FFFF_FFFF#;
   ...
   --  OpenGL 1.2
  GL_RESCALE_NORMAL                             : constant Integer_4_Unsigned_C := 16#0000_803A#;
  ...
  GL_TEXTURE_BINDING_3D                         : constant Integer_4_Unsigned_C := 16#0000_806A#;
   ...
   -- GL_ARB_imaging
  GL_CONSTANT_COLOR                             : constant Integer_4_Unsigned_C := 16#0000_8001#;
  ...
  GL_BLEND_COLOR                                : constant Integer_4_Unsigned_C := 16#0000_8005#;
   ...
   --  OpenGL 1.3
   --  multitexture
  GL_TEXTURE0                                   : constant Integer_4_Unsigned_C := 16#0000_84C0#;
  ...
  GL_MAX_TEXTURE_UNITS                          : constant Integer_4_Unsigned_C := 16#0000_84E2#;
   ...
   --  texture_cube_map
  GL_NORMAL_MAP                                 : constant Integer_4_Unsigned_C := 16#0000_8511#;
  ...
  GL_MAX_CUBE_MAP_TEXTURE_SIZE                  : constant Integer_4_Unsigned_C := 16#0000_851C#;
   ...
   --  texture_compression
  GL_COMPRESSED_ALPHA                           : constant Integer_4_Unsigned_C := 16#0000_84E9#;
  ...
  GL_COMPRESSED_TEXTURE_FORMATS                 : constant Integer_4_Unsigned_C := 16#0000_86A3#;
   ...
   --  multisample
  GL_MULTISAMPLE                                : constant Integer_4_Unsigned_C := 16#0000_809D#;
  ...
  GL_MULTISAMPLE_BIT                            : constant Integer_4_Unsigned_C := 16#2000_0000#;
   ...
   --  transpose_matrix
  GL_TRANSPOSE_MODELVIEW_MATRIX                 : constant Integer_4_Unsigned_C := 16#0000_84E3#;
  ...
  GL_TRANSPOSE_COLOR_MATRIX                     : constant Integer_4_Unsigned_C := 16#0000_84E6#;
   ...
   --  texture_env_combine
  GL_COMBINE                                    : constant Integer_4_Unsigned_C := 16#0000_8570#;
  ...
  GL_PREVIOUS                                   : constant Integer_4_Unsigned_C := 16#0000_8578#;
   ...
   --  texture_env_dot3
  GL_DOT3_RGB                                   : constant Integer_4_Unsigned_C := 16#0000_86AE#;
  GL_DOT3_RGBA                                  : constant Integer_4_Unsigned_C := 16#0000_86AF#;

   --  texture_border_clamp
  GL_CLAMP_TO_BORDER                            : constant Integer_4_Unsigned_C := 16#0000_812D#;

   -- GL_ARB_multitexture  (ARB extension 1 and OpenGL 1.2.1)
  GL_ARB_MULTITEXTURE                           : constant Integer_4_Unsigned_C := 1;
  ...
  GL_MAX_TEXTURE_UNITS_ARB                      : constant Integer_4_Unsigned_C := 16#0000_84E2#;
   ...
   -- GL_MESA_trace
  GL_MESA_TRACE                                 : constant Integer_4_Unsigned_C := 1;
  ...
  GL_MESA_PACKED_DEPTH_STENCIL                  : constant Integer_4_Unsigned_C := 1;
  ...
  GL_MESA_YCBCR_TEXTURE                         : constant Integer_4_Unsigned_C := 1;
  ...
  GL_UNSIGNED_SHORT_8_8_REV_MESA                : constant Integer_4_Unsigned_C := 16#0000_85BB#;
   ...
   -- GL_MESA_pack_invert
  GL_MESA_PACK_INVERT                           : constant Integer_4_Unsigned_C := 1;
  GL_PACK_INVERT_MESA                           : constant Integer_4_Unsigned_C := 16#0000_8758#;

   -- GL_DEPTH_BOUNDS
  GL_DEPTH_BOUNDS_TEST_EXT                      : constant Integer_4_Unsigned_C := 16#0000_8890#;
  GL_DEPTH_BOUNDS_EXT                           : constant Integer_4_Unsigned_C := 16#0000_8891#;

   -- GL_ARB_occlusion_query
  GL_ARB_OCCLUSION_QUERY                        : constant Integer_4_Unsigned_C := 1;

   -- GL_ARB
  GL_SAMPLES_PASSED_ARB                         : constant Integer_4_Unsigned_C := 16#0000_8914#;
  ...
  procedure Get_Integer_Vector(                 -- glGetIntegerv
    Name       : in Integer_4_Unsigned_C;       -- pname
    Parameters : in Access_Integer_4_Signed_C); -- params
    pragma Import(Stdcall, Get_Integer_Vector, "glGetIntegerv");
  -- procedure Get_Light(
