...
package Neo.System.Processor
  ...
  ------------------
    ...
    type Enumerated_Precision
      ...
      Single_Precision,
      Double_Precision,
      Double_Extended_Precision);
    for Enumerated_Precision
      use( -- Precision size in bits
      Single_Precision          => 24,
      Double_Precision          => 53,
      Double_Extended_Precision => 64);
  ...
  -----------------
    ...
    function Get_Specifics -- Delays SECONDS_FOR_PROCESSOR_SPEED_TIMING
...
-------
  ...
  ------------
    package Import
      is
        function Get_Specifics -- Ignore setting Speed_In_Megahertz
          return Record_Specifics;
        procedure Check_Exceptions;
        procedure Set_Rounding(
          Rounding : in Enumerated_Rounding);
