...
separate (Neo.Data.Model) package body Idtech is
  ...
  package Vector_Internal_Joint is new Core.Vectors (Internal_Joint_State);
  ...
  function Load (Path : Str) return Skeletal_Mesh_State is
    ...
    package Vector_Internal_Weight is new Core.Vectors (Internal_Weight_State);
    ...
    package Vector_Internal_Vertex is new Core.Vectors (Internal_Vertex_State);
  ...
  function Load (Path : Str) return Animation_State is
    ...
    package Vector_Internal_Joint_Base is new Core.Vectors (Internal_Joint_Base_State);
