...
package Neo.Windows is
    Primary_Window : Address := NULL_ADDRESS; -- Hack
    PIXEL_FORMAT_DRAW_TO_WINDOW : constant Integer_4_Unsigned_C := 16#0000_0004#; -- PFD_DRAW_TO_WINDOW
    PIXEL_FORMAT_SUPPORT_OPENGL : constant Integer_4_Unsigned_C := 16#0000_0020#; -- PFD_SUPPORT_OPENGL
    PIXEL_FORMAT_DOUBLEBUFFER : constant Integer_4_Unsigned_C := 16#0000_0001#; -- PFD_DOUBLEBUFFER
    ...
    EVENT_DESTROY                              : constant Integer_4_Unsigned_C := 16#0000_0002#; -- WM_DESTROY
    ...
    type Access_Record_Pixel_Descriptor is access all Record_Pixel_Descriptor;
    ...
    type Access_Function_OpenGL_Create_Context is access function( -- wglCreateContextAttribsARB
    ...
    type Access_Function_OpenGL_Get_Pixel_Format_Integer is access function( -- wglGetPixelFormatAttribivARB
      ...
      Layer_Plane    : in Integer_4_Signed_C; -- iLayerPlane
      Number_Of_Attributes     : in Integer_4_Unsigned_C; -- nAttributes
    ...
    type Access_Function_OpenGL_Choose_Pixel_Format is access function( -- wglChoosePixelFormatARB
      ...
      List_Floats    : in Access_Array_Float_4_Real_C; -- pfAttribFList
    ...
    function To_Unchecked_Access_OpenGL_Get_Pixel_Format_Float is new Ada.Unchecked_Conversion(Address, Access_Function_OpenGL_Get_Pixel_Format_Float);
    function To_Unchecked_Access_OpenGL_Choose_Pixel_Format is new Ada.Unchecked_Conversion(Address, Access_Function_OpenGL_Choose_Pixel_Format);
    function To_Unchecked_Access_OpenGL_Create_Context_Attributes is new Ada.Unchecked_Conversion(Address, Access_Function_OpenGL_Create_Context_Attributes);
    ...
    --   Flags         : in Integer_4_Unsigned_C)
    OpenGL_Get_Extensions            : Access_Function_OpenGL_Get_Extensions            := null;
    OpenGL_Swap_Interval             : Access_Function_OpenGL_Swap_Interval             := null;
    OpenGL_Get_Pixel_Format_Integer  : Access_Function_OpenGL_Get_Pixel_Format_Integer  := null;
    OpenGL_Get_Pixel_Format_Float    : Access_Function_OpenGL_Get_Pixel_Format_Float    := null;
    OpenGL_Choose_Pixel_Format       : Access_Function_OpenGL_Choose_Pixel_Format       := null;
    OpenGL_Create_Context_Attributes : Access_Function_OpenGL_Create_Context_Attributes := null;
    function Swap_Buffers( -- SwapBuffers
      Device_Context : in Address) -- hdc
      return Integer_4_Signed_C; -- BOOL
      pragma Import(Stdcall, Swap_Buffers, "SwapBuffers");
    function Choose_Pixel_Format( -- ChoosePixelFormat
      Device_Context : in Address; -- hdc
      Descriptor     : in Access_Record_Pixel_Descriptor) -- ppfd
      return Integer_4_Signed_C; -- int
      pragma Import(Stdcall, Choose_Pixel_Format, "ChoosePixelFormat");
    function OpenGL_Create_Context( -- wglCreateContext
      Device_Context : in Address) -- hdc
      return Address; -- HGLRC
      pragma Import(Stdcall, OpenGL_Create_Context, "wglCreateContext");
    function OpenGL_Delete_Context( -- wglDeleteContext
      Render_Context : in Address) -- hglrc
      return Integer_4_Signed_C; -- BOOL
      pragma Import(Stdcall, OpenGL_Delete_Context, "wglDeleteContext");
    function OpenGL_Get_Procedure_Address( -- wglGetProcAddress
      Name : in String_1_C) -- lpszProc
      return Address; -- PROC
      pragma Import(Stdcall, OpenGL_Get_Procedure_Address, "wglGetProcAddress");
    ...
    function OpenGL_Make_Current( -- wglMakeCurrent
      Device_Context : in Address; -- hdc
      Render_Context : in Address) -- hglrc
      return Integer_4_Signed_C; -- BOOL
      pragma Import(Stdcall, OpenGL_Make_Current, "wglMakeCurrent");
