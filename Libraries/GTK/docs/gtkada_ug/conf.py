# -*- coding: utf-8 -*-
#
# GtkAda documentation build configuration file, created by
# sphinx-quickstart on Thu Dec  8 15:31:22 2011.
#
...
latex_documents = [
  ('index', 'GtkAda.tex', u'GtkAda Documentation',
   u'AdaCore', 'manual'),
]
...
man_pages = [
    ('index', 'gtkada', u'GtkAda Documentation',
     [u'AdaCore'], 1)
]
