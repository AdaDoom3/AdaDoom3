...
package Neo.System.OpenGL
  ...
  -- Constants --
  ---------------
    GL_VERSION_1_1                     : constant Integer_4_Unsigned := 1;
    GL_ACCUM                           : constant Integer_4_Unsigned := 16#0100#;
    GL_LOAD                            : constant Integer_4_Unsigned := 16#0101#;
    GL_RETURN                          : constant Integer_4_Unsigned := 16#0102#;
    GL_MULT                            : constant Integer_4_Unsigned := 16#0103#;
    GL_ADD                             : constant Integer_4_Unsigned := 16#0104#;
    GL_NEVER                           : constant Integer_4_Unsigned := 16#0200#;
    GL_LESS                            : constant Integer_4_Unsigned := 16#0201#;
    GL_EQUAL                           : constant Integer_4_Unsigned := 16#0202#;
    GL_LEQUAL                          : constant Integer_4_Unsigned := 16#0203#;
    GL_GREATER                         : constant Integer_4_Unsigned := 16#0204#;
    GL_NOTEQUAL                        : constant Integer_4_Unsigned := 16#0205#;
    GL_GEQUAL                          : constant Integer_4_Unsigned := 16#0206#;
    GL_ALWAYS                          : constant Integer_4_Unsigned := 16#0207#;
    GL_CURRENT_BIT                     : constant Integer_4_Unsigned := 16#00000001#;
    GL_POINT_BIT                       : constant Integer_4_Unsigned := 16#00000002#;
    GL_LINE_BIT                        : constant Integer_4_Unsigned := 16#00000004#;
    GL_POLYGON_BIT                     : constant Integer_4_Unsigned := 16#00000008#;
    GL_POLYGON_STIPPLE_BIT             : constant Integer_4_Unsigned := 16#00000010#;
    GL_PIXEL_MODE_BIT                  : constant Integer_4_Unsigned := 16#00000020#;
    GL_LIGHTING_BIT                    : constant Integer_4_Unsigned := 16#00000040#;
    GL_FOG_BIT                         : constant Integer_4_Unsigned := 16#00000080#;
    GL_DEPTH_BUFFER_BIT                : constant Integer_4_Unsigned := 16#00000100#;
    GL_ACCUM_BUFFER_BIT                : constant Integer_4_Unsigned := 16#00000200#;
    GL_STENCIL_BUFFER_BIT              : constant Integer_4_Unsigned := 16#00000400#;
    GL_VIEWPORT_BIT                    : constant Integer_4_Unsigned := 16#00000800#;
    GL_TRANSFORM_BIT                   : constant Integer_4_Unsigned := 16#00001000#;
    GL_ENABLE_BIT                      : constant Integer_4_Unsigned := 16#00002000#;
    GL_COLOR_BUFFER_BIT                : constant Integer_4_Unsigned := 16#00004000#;
    GL_HINT_BIT                        : constant Integer_4_Unsigned := 16#00008000#;
    GL_EVAL_BIT                        : constant Integer_4_Unsigned := 16#00010000#;
    GL_LIST_BIT                        : constant Integer_4_Unsigned := 16#00020000#;
    GL_TEXTURE_BIT                     : constant Integer_4_Unsigned := 16#00040000#;
    GL_SCISSOR_BIT                     : constant Integer_4_Unsigned := 16#00080000#;
    GL_ALL_ATTRIB_BITS                 : constant Integer_4_Unsigned := 16#000fffff#;
    GL_POINTS                          : constant Integer_4_Unsigned := 16#0000#;
    GL_LINES                           : constant Integer_4_Unsigned := 16#0001#;
    GL_LINE_LOOP                       : constant Integer_4_Unsigned := 16#0002#;
    GL_LINE_STRIP                      : constant Integer_4_Unsigned := 16#0003#;
    GL_TRIANGLES                       : constant Integer_4_Unsigned := 16#0004#;
    GL_TRIANGLE_STRIP                  : constant Integer_4_Unsigned := 16#0005#;
    GL_TRIANGLE_FAN                    : constant Integer_4_Unsigned := 16#0006#;
    GL_QUADS                           : constant Integer_4_Unsigned := 16#0007#;
    GL_QUAD_STRIP                      : constant Integer_4_Unsigned := 16#0008#;
    GL_POLYGON                         : constant Integer_4_Unsigned := 16#0009#;
    GL_ZERO                            : constant Integer_4_Unsigned := 0;
    GL_ONE                             : constant Integer_4_Unsigned := 1;
    GL_SRC_COLOR                       : constant Integer_4_Unsigned := 16#0300#;
    GL_ONE_MINUS_SRC_COLOR             : constant Integer_4_Unsigned := 16#0301#;
    GL_SRC_ALPHA                       : constant Integer_4_Unsigned := 16#0302#;
    GL_ONE_MINUS_SRC_ALPHA             : constant Integer_4_Unsigned := 16#0303#;
    GL_DST_ALPHA                       : constant Integer_4_Unsigned := 16#0304#;
    GL_ONE_MINUS_DST_ALPHA             : constant Integer_4_Unsigned := 16#0305#;
    GL_DST_COLOR                       : constant Integer_4_Unsigned := 16#0306#;
    GL_ONE_MINUS_DST_COLOR             : constant Integer_4_Unsigned := 16#0307#;
    GL_SRC_ALPHA_SATURATE              : constant Integer_4_Unsigned := 16#0308#;
    GL_TRUE                            : constant Integer_4_Signed   := 1;
    GL_FALSE                           : constant Integer_4_Signed   := 0;
    GL_CLIP_PLANE0                     : constant Integer_4_Unsigned := 16#3000#;
    GL_CLIP_PLANE1                     : constant Integer_4_Unsigned := 16#3001#;
    GL_CLIP_PLANE2                     : constant Integer_4_Unsigned := 16#3002#;
    GL_CLIP_PLANE3                     : constant Integer_4_Unsigned := 16#3003#;
    GL_CLIP_PLANE4                     : constant Integer_4_Unsigned := 16#3004#;
    GL_CLIP_PLANE5                     : constant Integer_4_Unsigned := 16#3005#;
    GL_BYTE                            : constant Integer_4_Unsigned := 16#1400#;
    GL_UNSIGNED_BYTE                   : constant Integer_4_Unsigned := 16#1401#;
    GL_SHORT                           : constant Integer_4_Unsigned := 16#1402#;
    GL_UNSIGNED_SHORT                  : constant Integer_4_Unsigned := 16#1403#;
    GL_INT                             : constant Integer_4_Unsigned := 16#1404#;
    GL_UNSIGNED_INT                    : constant Integer_4_Unsigned := 16#1405#;
    GL_FLOAT                           : constant Integer_4_Unsigned := 16#1406#;
    GL_2_BYTES                         : constant Integer_4_Unsigned := 16#1407#;
    GL_3_BYTES                         : constant Integer_4_Unsigned := 16#1408#;
    GL_4_BYTES                         : constant Integer_4_Unsigned := 16#1409#;
    GL_DOUBLE                          : constant Integer_4_Unsigned := 16#140A#;
    GL_NONE                            : constant Integer_4_Unsigned := 0;
    GL_FRONT_LEFT                      : constant Integer_4_Unsigned := 16#0400#;
    GL_FRONT_RIGHT                     : constant Integer_4_Unsigned := 16#0401#;
    GL_BACK_LEFT                       : constant Integer_4_Unsigned := 16#0402#;
    GL_BACK_RIGHT                      : constant Integer_4_Unsigned := 16#0403#;
    GL_FRONT                           : constant Integer_4_Unsigned := 16#0404#;
    GL_BACK                            : constant Integer_4_Unsigned := 16#0405#;
    GL_LEFT                            : constant Integer_4_Unsigned := 16#0406#;
    GL_RIGHT                           : constant Integer_4_Unsigned := 16#0407#;
    GL_FRONT_AND_BACK                  : constant Integer_4_Unsigned := 16#0408#;
    GL_AUX0                            : constant Integer_4_Unsigned := 16#0409#;
    GL_AUX1                            : constant Integer_4_Unsigned := 16#040A#;
    GL_AUX2                            : constant Integer_4_Unsigned := 16#040B#;
    GL_AUX3                            : constant Integer_4_Unsigned := 16#040C#;
    GL_NO_ERROR                        : constant Integer_4_Unsigned := 0;
    ...
    GL_FOG_END                         : constant Integer_4_Unsigned := 16#0B64#;
    GL_FOG_MODE                        : constant Integer_4_Unsigned := 16#0B65#;
    GL_FOG_COLOR                       : constant Integer_4_Unsigned := 16#0B66#;
    GL_DEPTH_RANGE                     : constant Integer_4_Unsigned := 16#0B70#;
    GL_DEPTH_TEST                      : constant Integer_4_Unsigned := 16#0B71#;
    GL_DEPTH_WRITEMASK                 : constant Integer_4_Unsigned := 16#0B72#;
    GL_DEPTH_CLEAR_VALUE               : constant Integer_4_Unsigned := 16#0B73#;
    GL_DEPTH_FUNC                      : constant Integer_4_Unsigned := 16#0B74#;
    GL_ACCUM_CLEAR_VALUE               : constant Integer_4_Unsigned := 16#0B80#;
    GL_STENCIL_TEST                    : constant Integer_4_Unsigned := 16#0B90#;
    GL_STENCIL_CLEAR_VALUE             : constant Integer_4_Unsigned := 16#0B91#;
    GL_STENCIL_FUNC                    : constant Integer_4_Unsigned := 16#0B92#;
    GL_STENCIL_VALUE_MASK              : constant Integer_4_Unsigned := 16#0B93#;
    GL_STENCIL_FAIL                    : constant Integer_4_Unsigned := 16#0B94#;
    GL_STENCIL_PASS_DEPTH_FAIL         : constant Integer_4_Unsigned := 16#0B95#;
    GL_STENCIL_PASS_DEPTH_PASS         : constant Integer_4_Unsigned := 16#0B96#;
    GL_STENCIL_REF                     : constant Integer_4_Unsigned := 16#0B97#;
    GL_STENCIL_WRITEMASK               : constant Integer_4_Unsigned := 16#0B98#;
    GL_MATRIX_MODE                     : constant Integer_4_Unsigned := 16#0BA0#;
    GL_NORMALIZE                       : constant Integer_4_Unsigned := 16#0BA1#;
    GL_VIEWPORT                        : constant Integer_4_Unsigned := 16#0BA2#;
    GL_MODELVIEW_STACK_DEPTH           : constant Integer_4_Unsigned := 16#0BA3#;
    GL_PROJECTION_STACK_DEPTH          : constant Integer_4_Unsigned := 16#0BA4#;
    GL_TEXTURE_STACK_DEPTH             : constant Integer_4_Unsigned := 16#0BA5#;
    GL_MODELVIEW_MATRIX                : constant Integer_4_Unsigned := 16#0BA6#;
    GL_PROJECTION_MATRIX               : constant Integer_4_Unsigned := 16#0BA7#;
    GL_TEXTURE_MATRIX                  : constant Integer_4_Unsigned := 16#0BA8#;
    GL_ATTRIB_STACK_DEPTH              : constant Integer_4_Unsigned := 16#0BB0#;
    GL_CLIENT_ATTRIB_STACK_DEPTH       : constant Integer_4_Unsigned := 16#0BB1#;
    GL_ALPHA_TEST                      : constant Integer_4_Unsigned := 16#0BC0#;
    GL_ALPHA_TEST_FUNC                 : constant Integer_4_Unsigned := 16#0BC1#;
    GL_ALPHA_TEST_REF                  : constant Integer_4_Unsigned := 16#0BC2#;
    GL_DITHER                          : constant Integer_4_Unsigned := 16#0BD0#;
    GL_BLEND_DST                       : constant Integer_4_Unsigned := 16#0BE0#;
    GL_BLEND_SRC                       : constant Integer_4_Unsigned := 16#0BE1#;
    GL_BLEND                           : constant Integer_4_Unsigned := 16#0BE2#;
    GL_LOGIC_OP_MODE                   : constant Integer_4_Unsigned := 16#0BF0#;
    GL_INDEX_LOGIC_OP                  : constant Integer_4_Unsigned := 16#0BF1#;
    GL_COLOR_LOGIC_OP                  : constant Integer_4_Unsigned := 16#0BF2#;
    GL_AUX_BUFFERS                     : constant Integer_4_Unsigned := 16#0C00#;
    GL_DRAW_BUFFER                     : constant Integer_4_Unsigned := 16#0C01#;
    GL_READ_BUFFER                     : constant Integer_4_Unsigned := 16#0C02#;
    GL_SCISSOR_BOX                     : constant Integer_4_Unsigned := 16#0C10#;
    GL_SCISSOR_TEST                    : constant Integer_4_Unsigned := 16#0C11#;
    GL_INDEX_CLEAR_VALUE               : constant Integer_4_Unsigned := 16#0C20#;
    GL_INDEX_WRITEMASK                 : constant Integer_4_Unsigned := 16#0C21#;
    GL_COLOR_CLEAR_VALUE               : constant Integer_4_Unsigned := 16#0C22#;
    GL_COLOR_WRITEMASK                 : constant Integer_4_Unsigned := 16#0C23#;
    GL_INDEX_MODE                      : constant Integer_4_Unsigned := 16#0C30#;
    GL_RGBA_MODE                       : constant Integer_4_Unsigned := 16#0C31#;
    GL_DOUBLEBUFFER                    : constant Integer_4_Unsigned := 16#0C32#;
    GL_STEREO                          : constant Integer_4_Unsigned := 16#0C33#;
    GL_RENDER_MODE                     : constant Integer_4_Unsigned := 16#0C40#;
    GL_PERSPECTIVE_CORRECTION_HINT     : constant Integer_4_Unsigned := 16#0C50#;
    GL_POINT_SMOOTH_HINT               : constant Integer_4_Unsigned := 16#0C51#;
    GL_LINE_SMOOTH_HINT                : constant Integer_4_Unsigned := 16#0C52#;
    GL_POLYGON_SMOOTH_HINT             : constant Integer_4_Unsigned := 16#0C53#;
    GL_FOG_HINT                        : constant Integer_4_Unsigned := 16#0C54#;
    GL_TEXTURE_GEN_S                   : constant Integer_4_Unsigned := 16#0C60#;
    GL_TEXTURE_GEN_T                   : constant Integer_4_Unsigned := 16#0C61#;
    ...
    GL_CLIENT_PIXEL_STORE_BIT          : constant Integer_4_Unsigned := 16#00000001#;
    GL_CLIENT_VERTEX_ARRAY_BIT         : constant Integer_4_Unsigned := 16#00000002#;
    GL_CLIENT_ALL_ATTRIB_BITS          : constant Integer_4_Unsigned := 16#ffffffff#;
